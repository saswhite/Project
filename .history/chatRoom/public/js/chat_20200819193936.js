        ...
        $.ajax({
            ...
            success: (result) => {
                ...
                result.forEach((items) => {
                    let time = moment(items.createdAt).locale('zh-cn').format('YYYYMMMMDo aH:mm:ss')
                    ...
                    <div class="box3">
                        <div class='chat_date'>${date.replace(/\"/g, '')}</div>
                    </div>
                </div>`
                    $('.content').html(html)
                })
        ...
        $.ajax({
            ...
            success: (result) => {
                ...
                result.forEach((items) => {
                    ...
                    <div class="box3">
                        <div class='chat_date'>${moment(items.createdAt).locale('zh-cn').format('YYYYMMMMDo aH:mm:ss')}</div>
                    </div>
                </div>`
                    $('.content').html(html)
                })
